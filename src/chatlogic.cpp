...
ChatLogic::~ChatLogic()
{
    ...
    // TODO: nodes automatically deallocated because they are unique pointers?
    // delete all nodes
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // NOTE: since we only inspect the node (unique pointer), it is ok to pass it by reference.
                        // TODO: wouldn't it be better to get the raw pointer before passing to the function in order to comply with the guidelines?
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // TODO: again: better to get raw pointer before passing to the function?
